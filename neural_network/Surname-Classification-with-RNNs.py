...
args = Namespace(
    ...
    save_dir="../word_segmentation/model_storage/ch6/surname_classification",
...
print(f"模型在测试集上的损失值: {train_state['test_loss']}")
print(f"模型在测试集上的分类准确率: {train_state['test_acc']}%")
...
for surname in surnames:
    ...
    print(f"姓: {result['surname']}, 预测国籍: {result['nationality']}, 概率置信度: {result['probability']}")
